...
const countries: Country[] = [
  ...
  { code: "+44", flag: "🇬🇧", name: "Spojené kráľovstvo" },
];
    ...
    <div className="fixed inset-0 overflow-y-auto" style={{
      ...
      <div className="max-w-screen-sm mx-auto w-full px-5 pt-safe pb-8 min-h-full flex flex-col box-border">
          ...
          <div className="space-y-6 flex-1">
            <div className="pt-4">
              ...
              <p className="text-foreground/80 mb-8">
                Zadajte číslo, ktoré chcete mať priradené k účtu.
              </p>
            </div>
        ...
        {step === 2 && (
          <div className="space-y-6 flex-1">
            <div className="pt-4">
              ...
              <p className="text-foreground/80 mb-8">
                V ktorej krajine máte trvalý pobyt?
              </p>
            </div>
        ...
        {step === 3 && (
          <div className="space-y-6 flex-1">
            <div className="pt-4">
              ...
              <p className="text-foreground/80 mb-8">
                Meno podľa dokladu — presne ako ho uvidíte na faktúre alebo prevode.
              </p>
            </div>
            <input
              type="text"
        ...
        {step === 4 && (
          <div className="space-y-6 flex-1">
            <div className="pt-4">
              ...
              <p className="text-foreground/80 mb-8">
                Medzinárodné číslo účtu (IBAN), na ktoré vám môžu posielať platby.
              </p>
            </div>
            <input
              type="text"
        ...
        <div className="mt-8">
          ...
          >
            {step === 4 ? "Dokončiť registráciu" : "Pokračovať"}
          </Button>
        </div>
      </div>
    </div>
